...
const Guide = ({number, title, description, lightBg, first}) => {
	return ( 
		<GuideContainer lightBg={lightBg} first={first} >
			<GuideWrapper first={first} >
				<GuideRow>
					...
					<GuideColumn2>
						<ImgWrap>
							<video  autoPlay loop muted src="/video02.mp4" type="video/mp4" style={{ maxWidth: 250, borderRadius: 20, border: '0.5px solid #E1E2E3 ' }} />
						</ImgWrap>
					</GuideColumn2>
				</GuideRow>
			</GuideWrapper>
