import { Heading, MentoriaClassesColumn1, MentoriaClassesColumn2, MentoriaClassesContainer, MentoriaClassesHeading, MentoriaClassesRow, MentoriaClassesWrapper, ImgWrap, ServicesCard, ServicesH2, ServicesIcon, ServicesP, ServicesRow, Subtitle, TextWrapper, ProfilePicWrap, BoxWrap } from "./MentoriaClassesStyles";
import Image from 'next/image'
import { ButtonScorll } from "../UsefulComponents";
import { FaBookOpen, FaRoad, FaVideo, FaWhatsapp } from "react-icons/fa";

const MentoriaClasses = () => {
    return ( 
        <MentoriaClassesContainer id="MentoriaClasses">
					<MentoriaClassesWrapper>
						...
						<MentoriaClassesRow style={{marginTop: 40}} invert >
							<MentoriaClassesColumn1>
								<TextWrapper first>
...
export default MentoriaClasses;