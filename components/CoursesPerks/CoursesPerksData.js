import { FaCalendarDay, FaLayerGroup, FaRoad, FaRocket, FaStethoscope, FaWhatsapp } from "react-icons/fa";

export const CoursesPerksList = [
	{
		id: 1,
		icon: <FaRocket size={50} color="#411551" />,
		title: 'Metodologia Ativa',
		description: 'Chega de enrolação e vamos colocar o conhecimento em prática rumo à aprovação!'
	},
	{
		id: 2,
